...
public class DockingStationRestController {
	...
	public DockingStation getOneDockingStation() {
		...
		System.out.println(dock.getNaam());
		return dock;
	}
	...
	public void fillDB() {
		...
		dockingStation.setNaam("Centrum Eindhoven");
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Stadion Eindhoven");
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Strijp-S Eindhoven");
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Tongelre Eindhoven");
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Gestel Eindhoven");
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Stratum Eindhoven");
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Woensel Zuid Eindhoven");
		dockingStation.setLat(51.420344);
		dockingStation.setLng(5.496238);
		dockingstationService.save(dockingStation);
		dockingStation = new DockingStation();
		...
		dockingStation.setActive(true);
		dockingStation.setNaam("Woensel Noord Eindhoven");
